  ...
  if (Array.isArray(arr)) {
    ...
    for (let [index, item] of arr.entries()) {
      ...
      switch (itemSchema.type) {
        case "object":
          arr[index] = parseObjectContents(item, parseInfo);
          break;
        case "array":
          arr[index] = parseArrayContents(item, parseInfo);
          break;
        default:
  ...
  if (typeof obj === "object" && obj !== null) {
    ...
    for (let [key, item] of Object.entries(obj)) {
      ...
      switch (parseInfo.schema.type) {
        case "object":
          obj[key] = parseObjectContents(item, parseInfo);
          break;
        case "array":
          obj[key] = parseArrayContents(item, parseInfo);
          break;
        default:
